# Generated by Django 4.0.1 on 2022-07-18 09:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='binapp.customer')),
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='binapp.driver')),
            ],
        ),
        migrations.CreateModel(
            name='Complaintdriver',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
